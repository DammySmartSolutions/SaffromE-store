...
namespace SaffromEstore.DataAccess.Migrations
{
    ...
    [Migration("20260612211420_AddDisplayName")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SaffromEstore.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("SaffromEstore.Models.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SaffromEstore.Models.OrderDetails", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SaffromEstore.Models.OrderHeader", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SaffromEstore.Models.Product", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SaffromEstore.Models.ShoppingCart", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("SaffromEstore.Models.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("SaffromEstore.Models.OrderDetails", b =>
                {
                    b.HasOne("SaffromEstore.Models.OrderHeader", "OrderHeader")
                        .WithMany("OrderDetails")
                        .HasForeignKey("OrderHeaderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SaffromEstore.Models.Product", "Product")
                        .WithMany()
            ...
            modelBuilder.Entity("SaffromEstore.Models.OrderHeader", b =>
                {
                    b.HasOne("SaffromEstore.Models.ApplicationUser", "ApplicationUser")
                        .WithMany()
            ...
            modelBuilder.Entity("SaffromEstore.Models.Product", b =>
                {
                    b.HasOne("SaffromEstore.Models.Category", "Category")
                        .WithMany()
